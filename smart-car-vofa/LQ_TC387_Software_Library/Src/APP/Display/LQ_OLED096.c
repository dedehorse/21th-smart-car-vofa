...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void lq_oled_short_delay(unsigned int Del)
@功能说明：简单延时函数
@参数说明：Del_1ms ：延时时间
@函数返回：无
@调用方法：lq_oled_short_delay(1);
@备    注：
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_WrDat(unsigned char data)
@功能说明： OLED画点命令
@参数说明：data ：要画的点
@函数返回：无
@调用方法：OLED_WrDat(0xFF);
@备    注：内部调用
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
@参数说明： x：坐标  y：坐标
@函数返回：无
@调用方法：OLED_Set_Pos(0,5);
@备    注：左上角为0,0  右下角 127,63（内部调用）
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_Fill(void)
@功能说明：OLED全亮
@参数说明：无
@函数返回：无
@调用方法：OLED_Fill(); //OLED全亮 用于检测坏点
@备    注：
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
void OLED_Fill(void)
{
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_PutPixel(unsigned char x,unsigned char y)
@功能说明：画一个点
@参数说明：x: 0-127   y: 0-63
@函数返回：无
@调用方法：OLED_PutPixel(120,60);
@备    注：OLED是按字节显示的 一个字节8位，代表8个纵向像素点，因此如果画点
@         OLED_PutPixel(0,0); OLED_PutPixel(0,1); 只会显示点(0, 1) (0,0)则在画点(0,1)时清除掉
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_ClrDot(unsigned char x,unsigned char y)
@功能说明：清除8个点
@参数说明：x: 0-127   y: 0-63
@函数返回：无
@调用方法：OLED_ClrDot(0, 0); //清除(0,0)-(0,7)8个点 左上角为0,0  右下角 127,63
@备    注：OLED是按字节显示的 一个字节8位，代表8个纵向像素点，
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_Rectangle(unsigned char x1,unsigned char y1,unsigned char x2,unsigned char y2,unsigned char gif)
@功能说明：画矩形
@参数说明：x1: 0-127  y1: 0-63  左上角坐标（x1,y1）  x2: 0-127  y2: 0-63 右下角坐标（x2，y2）gif : 是否开启动画效果
@函数返回：无
@调用方法：OLED_Rectangle(0, 0, 127,62,0);   //绘制矩形
@备    注：
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_P6x8Str(unsigned char x,unsigned char y, char ch[])
@功能说明：写入一组标准ASCII字符串
@参数说明：x: 0-127   y: 0-7  ch : 要显示的字符串
@函数返回：无
@调用方法：OLED_P6x8Str(0,0,"OLED 3.");  //显示字符串
@备    注：
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_P8x16Str(unsigned char x,unsigned char y, char ch[])
@功能说明：写入一组标准ASCII字符串
@参数说明：x: 0-127   y: 0-7  ch : 要显示的字符串
@函数返回：无
@调用方法：OLED_P8x16Str(0,0,"OLED 3.");  //显示字符串
@备    注：一个字符高16  OLED高度64
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_P14x16Str(unsigned char x,unsigned char y, unsigned char ch[])
@功能说明：输出汉字字符串
@参数说明：x: 0-127   y: 0-7  ch : 要显示的字符串
@函数返回：无
@调用方法：OLED_P14x16Str(0,4,"北京龙邱");   //显示汉字
@备    注：一个字符高16  OLED高度64   字库需要自己制作
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_Show_BMP(unsigned char x0,unsigned char y0,unsigned char
@                             wide,unsigned char high,const unsigned char * bmp)
@功能说明：显示BMP图片 最大 128×64
@参数说明：x0:0-127   y0:0-63左上角坐标（x0,y0） wide:1-127 图片宽度
@参数说明：                  high:1-64    图片高度bmp : 要显示的图片
@函数返回：无
@调用方法：OLED_Show_BMP(0, 0, 104, 64, longqiu104x64); //画龙邱loge
@备    注：图片需要用软件转化
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_Show_LQLogo(void)
@功能说明：显示龙邱图片128×64
@参数说明：无
@函数返回：无
@调用方法：OLED_Show_LQLogo();
@备    注：无
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_Show_Frame80(void)
@功能说明：画边线 OV7725显示图像时 可以用这个画边线
@参数说明：无
@函数返回：无
@调用方法： OLED_Show_Frame80();
@备    注：无
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_Show_Frame94(void)
@功能说明：画边线 MT9V034显示图像时 可以用这个画边线
@参数说明：无
@函数返回：无
@调用方法：OLED_Show_Frame94();
@备    注：无
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
...
/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void OLED_Road(unsigned short high, unsigned short wide, unsigned char *Pixle)
@功能说明：OLED 二值化图像显示
@参数说明：Pixle：显示图像数据地址 wide ：显示图像宽度 high ：显示图像高度
@函数返回：无
@调用方法：OLED_Road(OLEDH, OLEDW, (unsigned char *)Pixle);
@备    注：无
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
 ...
 *
 * @see      OLED_P6x8Str(1, 1, "123456",);
 *
 */
void OLED_ShowStr(unsigned char x, unsigned char y, char *s_dat,
                  unsigned short fc, unsigned short pc, unsigned char size)
{
#pragma warning 523 // 屏蔽警告
    if (size == 12)
        OLED_P6x8Str(x, y, s_dat);
    else if (size == 16)
        OLED_P8x16Str(x, y, s_dat);
//  else if(size == 24) OLED_P14x16Str(x,y,s_dat);
//  else if(size == 32) OLED_P14x16Str(x,y,s_dat);
#pragma warning default // 打开警告
}

/*LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
@函数名称：void Test_OLED(void)
@功能说明：OLED 测试函数
@参数说明：无
@函数返回：无
