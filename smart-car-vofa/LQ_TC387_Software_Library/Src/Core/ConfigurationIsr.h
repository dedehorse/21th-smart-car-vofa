...
#define ISR_PRIORITY_PRINTF_ASC0_TX IfxSrc_Tos_cpu0  /**< \brief Define the ASC0 transmit interrupt priority used by printf.c */
#define ISR_PRIORITY_PRINTF_ASC0_EX IfxSrc_Tos_cpu0  /**< \brief Define the ASC0 error interrupt priority used by printf.c */

#define ISR_PRIORITY_STM_INT0       IfxSrc_Tos_cpu0 /**< \brief Define the System Timer Interrupt priority.  */
/** \} */
