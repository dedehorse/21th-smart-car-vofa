...
（智能车小白华南赛比赛所用代码 只有方向环和速度环 三串环由于新车模编码器用不了没时间调）基于 Infineon AURIX TC387QP 和龙邱 LQ_TC387 软件库的智能车最终版工程。它把“看见赛道、理解赛道、控制车辆、观察结果、在线调参”串成一个完整闭环，适合竞赛开发、嵌入式学习和控制算法验证。
